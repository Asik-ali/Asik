...
import { FaFacebook, FaInstagram, FaXTwitter, FaLinkedin } from "react-icons/fa";
            ...
            <div className='flex justify-around lg:flex-row flex-col ps-5 gap-6 lg:gap-0 lg:ps-0 '>
                ...
                <div>
                    ...
                    <ul className='flex flex-col space-y-4 text-[18px] font-medium text-gray-500'>
                        ...
                        <li className='flex items-center cursor-pointer gap-2 hover:text-emerald-900'><TiChevronRightOutline className='text-green-950' />Careers</li>
