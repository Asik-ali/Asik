...
const [CounterOn,SetCounter]=useState(false)
    return (
        <section className="py-12   sm:py-16 md:py-20 lg:py-24 bg-[#E7A93C] flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-8 lg:ps-32 ps-2">
            <div className="flex-1 md:max-w-md mx-auto md:mx-0 md:mr-8 ps-1">
                <h1 className=" text-3xl font-extrabold sm:text-4xl mb-4 sm:mb-6 lg:pt-16 text-center">Latest blog posts</h1>
                <p className=" mb-6 ps-5 lg:ps-0">Blogs that are loved by the community. Updated every hour.</p>
            ...
            <div className="flex-1 max-w-screen-xl mx-auto mt-8 md:mt-0 px-1">
                <div className="max-w-2xl mx-auto ">
                    <h3 className=" text-3xl font-semibold sm:text-4xl mb-4 sm:mb-6 text-center">Our customers are always happy</h3>
                    <p className=" ps-3">We understand that every student is unique. Our tutors tailor their approach to meet individual learning styles and needs.</p>
                </div>
                <div className="mt-12">
