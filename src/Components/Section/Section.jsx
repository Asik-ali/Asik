          ...
          <div className="bg-[#6062DC] p-8 md:p-12 lg:px-16 lg:py-24">
            <div className="mx-auto max-w-xl text-center">
              ...
              <p className=" text-white/90 sm:mt-4 sm:block">
                ...
                the practical skills and critical thinking necessary to thrive in the world. Through hands-on projects,
                internships, and community engagement, we aim to bridge the gap between theory and practice,
                empowering our students to apply their knowledge in meaningful ways.
              </p>
